package com.careup.ordering.common.file;

import com.careup.ordering.common.exception.FileHandlingException;
...
public class AwsS3Uploader {
    ...
    public String uploadFile(final String tableName, final Long objectSeq, final MultipartFile multipartFile) {
        try {
            ...
            throw new FileHandlingException("s3 파일 업로드에 실패했습니다.", e);
        }
    }
    ...
    public void deleteByUrl(final String fileUrl) {
        try {
            ...
            throw new FileHandlingException("s3 파일 삭제에 실패했습니다.", e);
        }
    }
